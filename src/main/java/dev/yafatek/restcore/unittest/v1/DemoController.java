...
//    protected final GenericRepo<DemoEntity, UUID> demoEntityUUIDDemoRepo;
//    protected final ApiServices<DemoEntity, UUID> apiServices ; //= new ApiServicesWrapper<>(demoEntityUUIDDemoRepo) {
//   // };
//
//    public DemoController(DemoRepo<DemoEntity, UUID> demoEntityUUIDDemoRepo) {
//        this.demoEntityUUIDDemoRepo = demoEntityUUIDDemoRepo;
//        apiServices = new ApiServicesWrapper<>(demoEntityUUIDDemoRepo) {
//        };
//    }
//
//    @GetMapping
